          ...
          {historyLoading ? (
            ...
            <div style={{ overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead><tr>{['Reference','Recipient','Type','Amount','Date','Status'].map(h => <th key={h} style={{ padding: '6px 10px', textAlign: 'left', color: colors.textFaint, fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', borderBottom: `1px solid ${colors.border}` }}>{h}</th>)}</tr></thead>
                <tbody>
                  {history.map(tx => (
