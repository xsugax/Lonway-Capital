    ...
    <div style={{ background: colors.bg, minHeight: '100vh', color: colors.text, fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <svg width="28" height="28" viewBox="0 0 36 36" fill="none">
            ...
            <line x1="7.5" y1="27" x2="28.5" y2="27" stroke={colors.gold} strokeWidth="1" strokeLinecap="round"/>
          </svg>
          LONDWAY
        </span>
        </div>
      ...
      {/* Nav links row — horizontal, left-aligned under logo */}
      <nav className="layout-nav-row" style={{
        display: 'flex', alignItems: 'center', gap: 2, padding: '0.5rem 2rem',
        background: colors.navBg, borderBottom: `1px solid ${colors.border}`,
        ...
        {NAV_KEYS.map(({ href, key }) => (
          <Link key={href} href={href} legacyBehavior>
            <a style={{
              ...
              padding: '0.35rem 0.75rem', borderRadius: 8, whiteSpace: 'nowrap',
